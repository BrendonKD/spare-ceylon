...
import "./CustomerProfileSettings.css"; // Reuse similar CSS (below)
import Header from "../components/header";
import CustomerSidebar from "../components/CustomerSidebar"; // Assuming you have this
...
const CustomerProfileSettings = () => {
    ...
    const handleFileChange = (e) => {
        ...
        if (file.type.startsWith("image/")) {
            ...
            // Update profile_image in form if needed, but backend handles it
        }
    };
    ...
    const handleProfileSave = async (e) => {
        ...
        try {
            ...
            if (files.profile_image) payload.append("profile_image", files.profile_image);
            ...
            setProfileForm({ ...profileForm, ...res.data });
            setOriginalProfileForm({ ...profileForm, ...res.data });
    ...
    const handleSecuritySave = async (e) => {
        ...
        try {
            ...
            setCustomer((prev) => ({ ...prev, email: res.data.user.email }));
            setSecurityForm((prev) => ({
                ...prev,
    ...
    return (
        <div className="customer-dashboard">
            ...
            <div className="cd-layout">
                <CustomerSidebar user={customer} handleLogout={handleLogout} activeItem="settings" />
                <main className="cd-main">
                    <div className="cps">
                        ...
                        {message.text && <div className={`cps-msg ${message.type}`}>{message.text}</div>}
                                    ...
                                    <div className="cps-profile-row">
                                        <div className="cps-profile-box">
                                            {customer.profile_image ? (
                                                <img src={fileUrl(customer.profile_image)} alt="Profile" className="cps-profile-img" />
                                            ) : (
                                        ...
                                        <div className="cps-grow">
                                            ...
                                            <input type="file" name="profile_image" accept="image/*" onChange={handleFileChange} />
